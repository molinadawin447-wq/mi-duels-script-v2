...
local tpDownButton = createButton(
    "Button6",
    buttonTexts[6],
    (buttonSize + gap) * 2,
    (buttonSize + gap) * 2
...
spiderButton.Size = UDim2.fromOffset(
    110,
    43
)

spiderButton.AnchorPoint = Vector2.new(
    0,
    0.5
)

spiderButton.Position = UDim2.new(
    0,
    15,
    0.36,
    0
...
spiderButton.BackgroundColor3 = Color3.fromRGB(
    0,
    0,
    0
)
...
spiderText.TextColor3 = Color3.fromRGB(
    255,
    255,
    255
)
...
spFrame.Size = UDim2.fromOffset(
    380,
    34
)

spFrame.Position = UDim2.new(
    0.5,
    0,
    1,
    -65
...
spFrame.AnchorPoint = Vector2.new(
    0.5,
    1
)
...
autoStealBackground.Size = UDim2.new(
    1,
    0,
    1,
    0
...
autoStealBackground.Position = UDim2.fromOffset(
    0,
    0
)
...
autoStealBackground.Image = getcustomasset(
...
barSpiderText.Size = UDim2.fromOffset(
    125,
    34
)

barSpiderText.Position = UDim2.fromOffset(
    5,
    0
)
...
spiderGradient.Offset = Vector2.new(
    -1.5,
    -1.5
)
...
pctLabel.Size = UDim2.fromOffset(
    45,
    34
)

pctLabel.Position = UDim2.fromOffset(
    135,
    0
)
...
barBg.Size = UDim2.fromOffset(
    100,
    18
)

barBg.Position = UDim2.fromOffset(
    185,
    8
)

barBg.BackgroundColor3 = Color3.fromRGB(
    50,
    50,
    50
)
...
separator.Position = UDim2.fromOffset(
    292,
    7
)
...
pingLabel.Size = UDim2.fromOffset(
    65,
    34
)

pingLabel.Position = UDim2.fromOffset(
    310,
    0
)
