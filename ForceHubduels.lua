...
loadingLabel.TextColor3 = Color3.new(1, 0, 0)
...
local function fadeOut()
    ...
    while elapsed < fadeDuration do
        ...
        loadingLabel.TextTransparency = 1 - alpha
...
local function setupSpeedIndicator(char)
    ...
    local discordLabel=Instance.new("TextLabel",bb);discordLabel.Size=UDim2.new(1,0,0.4,0);discordLabel.BackgroundTransparency=1;discordLabel.Text="Force Hub"
...
local function findMedusa()
    ...
    local bp=LP:FindFirstChild("Backpack");if bp then for _,t in ipairs(bp:GetChildren()) do if t:IsA("Tool") then local n=t.Name:lower();if n:find("medusa") or n:find("head") or n:find("stone") then return t end end end
    return nil
end
...
;(function()
    ...
    GuiHub.Name="ForceHub"  -- renamed from "SpectrumHub"
    ...
    Outer.Name="Outer"
    Outer.Size=UDim2.new(0, menuWidth, 0, menuHeight)
    ...
    Inner.Parent=Outer
    guiCorner(Inner,24)
    guiStroke(Inner,Color3.fromRGB(45,45,45),1.5)
    GuiRefs.inner=Inner
    ...
    ML.Position=UDim2.new(0,14,0,32)
    ML.Size=UDim2.new(0,200,0,14)
    ML.BackgroundTransparency=1
    ML.Text="Force Hub"
    ML.TextColor3=C.textDim
    ML.TextSize=10
    ...
    CloseBtn.BackgroundColor3=C.bgDark
    ...
    CloseBtn.ZIndex=5
    CloseBtn.Parent=HF
    guiCorner(CloseBtn,7)
    guiStroke(CloseBtn,Color3.fromRGB(45,45,45),1)
    ...
    MiniBtn.BackgroundColor3=C.bgDark
    ...
    guiCorner(MiniBtn,8)
    guiStroke(MiniBtn,Color3.fromRGB(45,45,45),1.2)
    ...
    HSep.Position=UDim2.new(0,14,0,62)
    HSep.Size=UDim2.new(1,-28,0,1)
    HSep.BackgroundColor3=C.blue
    HSep.BackgroundTransparency=0.7
    ...
    CatList.ScrollBarImageColor3=C.blue
    ...
    CF.Size=UDim2.new(1,-85,1,-118)
    CF.Position=UDim2.new(0,85,0,63)
    CF.BackgroundTransparency=1
    CF.BorderSizePixel=0
    CF.ScrollBarThickness=6
    CF.ScrollBarImageColor3=C.blue
    ...
    BotSep.Position=UDim2.new(0,8,1,-54)
    BotSep.Size=UDim2.new(1,-16,0,1)
    BotSep.BackgroundColor3=C.blue
    BotSep.BackgroundTransparency=0.65
